<footer class="bg-white p-6">
    <div class="flex container md:justify-between">
        <div class="mb-6 md:mb-0">
            <a href="/" class="flex items-center">
                <img src="{{ asset('logo.svg') }}" class="mr-3 h-12" alt="Goodshop логотип" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap">Goodshop</span>
            </a>
        </div>
        <div>
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <ul class="text-gray-600 ">
                    ...
                    <li>
                        <a href="{{ route('products.list') }}" class="hover:underline">Магазин</a>
                    </li>
                </ul>
            </div>
        </div>
