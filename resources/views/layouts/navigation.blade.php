<nav x-data="{ open: false }" class="bg-white z-50 sticky border-b shadow border-gray-200 left-0 top-0">
    ...
    <div class="xl:container mx-auto px-4 md:px-4 lg:px-8">
        <div class="flex justify-between gap-5">
            <div class="flex xl:gap-10 md:gap-2 w-full">
                <!-- Logo -->
            ...
            <form action="{{ route('products.list') }}" class="my-auto hidden md:flex">
